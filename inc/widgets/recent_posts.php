...
class jlt_Widget_Recent_Posts extends WP_Widget {
    ...
    public function __construct() {
        $widget_ops = array(
            ...
            'description' => __( 'Your site&#8217;s most recent Posts as cards' ),
            'customize_selective_refresh' => true,
        );
        parent::__construct( 'indie-studio-recent-posts', __( 'JLT Recent Posts' ), $widget_ops );
        $this->alt_option_name = 'jlt_widget_recent_entries';
    }
    ...
    public function widget( $args, $instance ) {
        ...
        <div class="grid-container basic">
            ...
            foreach ( $recent_posts->posts as $post ) :
                ...
                get_template_part( 'template-parts/post/widget-card-recent', get_post_format() );
...
add_action( 'widgets_init', function(){
	register_widget( 'jlt_Widget_Recent_Posts' );
});
