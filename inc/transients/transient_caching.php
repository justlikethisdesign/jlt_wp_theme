...
function get_transient_array($transName, $function, $lifespan) {
    ...
    $transient_name = 'jlt_tran_'.$transName. '_' . jlt_version();
    ...
    // Nope!  We gotta make a call.
        ...
        if($out){
            ...
            //Get transient time
            $lifespan = jlt_general_transient_lifespan($lifespan);
                    
            set_transient( $transient_name, $out, $lifespan );
            jlt_store_transient_in_list( $transient_name );
...
function jlt_general_transient_lifespan($lifespan) {
...
function jlt_clean_down_all_transients(){
    
    $transient_list = jlt_get_transient_list();
 ...
 * and stores it in the JLT Transient Array.
 * 
 * This array can be used to mass clean all 
 * JLT transients
 */

function jlt_store_transient_in_list( $transient_name ){
    ...
    update_option( 'jlt_transient_storage', $transient_list );
    
}



function jlt_get_transient_list(){
    
    $transient_list = get_option('jlt_transient_storage');
