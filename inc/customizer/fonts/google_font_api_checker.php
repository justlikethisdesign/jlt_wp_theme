...
class Google_Font_API_Checker_Section extends WP_Customize_Control {
    ...
    <label>
        ...
        <a class="button customizer-edit" title="Add the Google API key" data-control="jlt_google_api" href="<?php echo admin_url( '/customize.php?autofocus[section]=jlt_google_api' );?>">Add key</a>
    </label>
