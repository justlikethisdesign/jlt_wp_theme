...
<div class="logo">
    <a href="<?php echo site_url();?>">
        ...
        //Get logo filepath
        $custom_logo =  get_theme_mod( 'jlt_site_logo' );
...
<div class="header-menu-wrap group">
    ...
    <!-- Main Menu -->
    <nav id="site-navigation" class="main-navigation" role="navigation" aria-label="<?php esc_attr_e( 'Top Menu', jlt_text_domain() ); ?>">
