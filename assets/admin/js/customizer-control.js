(function( $ ) {
    ...
    wp.customize.bind( 'ready', function() {
        ...
        customize.section( 'jlt_fonts_colours_section' ).expanded.bind( function( isExpanding ) {
            if ( isExpanding ){
                toggle_google_api_visibility();
            }
        } );
        ...
        function toggle_google_api_visibility(){
            var google_font_warning = customize.control('jlt_font_api_missing');   
            if ( customize( 'jlt_google_api' ).get().length < 0 ){
