( function( $ ) {
    ...
    //Show Header Search
	customize( 'jlt_header_search', function( value ) {
	...
	customize( 'jlt_background_colour', function( value ) {
		value.bind( function( newval ) {            
    ...
    //Update Google Fonts
	customize( 'jlt_heading_font_selector', function( value ) {
        value.bind( function( newval ) {    
            $.ajax({
                type       : "POST",
	...
	customize( 'jlt_paragraph_font_selector', function( value ) {  
        value.bind( function( newval ) {            
            $.ajax({
                type       : "POST",
                url        : ajax_customizer.ajax_url,
	...
	customize( 'jlt_heading_text_colour', function( value ) {
		value.bind( function( newval ) {            
	...
	customize( 'jlt_paragraph_text_colour', function( value ) {
		value.bind( function( newval ) {            
